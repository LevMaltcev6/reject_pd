...
${originalSignature}` : "");
  ...
  function notificationState(prepared) {
    ...
    for (const element of prepared.root.ownerDocument.querySelectorAll(
      ...
      states.set(element, {
        acknowledgement: sentNotice.exec(normalize2(element.textContent))?.[0],
        firstText
      });
    }
    return states;
  ...
  async function sendLetter(prepared, signal, beforeClick) {
    ...
    try {
      ...
      const observeSuccess = (records = []) => {
        ...
        for (const [node, state] of notificationState(prepared)) {
          const previous = baseline.get(node);
          if (state.acknowledgement && (previous?.acknowledgement !== state.acknowledgement || previous.firstText !== state.firstText || state.firstText && refreshedText.has(state.firstText)))
            acknowledged = true;
        }
      };
  ...
  var CurrentTabTransport = class {
    ...
    async prepare(letter, signal, progress) {
      ...
      try {
        ...
        await sendLetter(prepared, localSignal, () => {
          guard();
...
${values["\u0424\u0418\u041E"]}`
  ...
  async function createSurface(doc = document) {
    ...
    return {
      ...
      compact() {
        ...
        frame.style.setProperty("height", "164px", "important");
  ...
  function createLauncher(createPanel, doc = document) {
    ...
    trigger.type = "button";
    const label = "\u2197 \u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.1";
    ...
    try {
      GM_registerMenuCommand(
        "\u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.1 \u2014 \u043E\u0442\u043A\u0440\u044B\u0442\u044C",
        () => void open()
      );
    } catch {
    }
  ...
  async function mountPanel(onClose) {
    ...
    function preview() {
      ...
      deliveryNote.textContent = autoSend ? "\u041A\u043D\u043E\u043F\u043A\u0430 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C\xBB \u0437\u0430\u043F\u0443\u0441\u043A\u0430\u0435\u0442 \u0440\u0430\u0441\u0441\u044B\u043B\u043A\u0443 \u0432\u0441\u0435\u043C \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u043C \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u044F\u043C \u0432 \u044D\u0442\u043E\u0439 \u0432\u043A\u043B\u0430\u0434\u043A\u0435. \u041F\u043E\u0441\u043B\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u044F \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438 \u043E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442\u0441\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0439 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440. \u041E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0442\u0435\u043A\u0441\u0442 \u0438\u0437 \u043F\u0440\u0435\u0434\u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0430, \u0431\u0435\u0437 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F \u0444\u0430\u0439\u043B\u043E\u0432 \u0438 \u043F\u043E\u0434\u043F\u0438\u0441\u0438 \u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0430. \u0415\u0441\u043B\u0438 \u043E\u043D\u0438 \u043D\u0443\u0436\u043D\u044B, \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \xAB\u0422\u043E\u043B\u044C\u043A\u043E \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A\u0438\xBB. \u041F\u0440\u043E\u043F\u0443\u0441\u043A\u0438 \u0434\u043E\u043F\u043E\u043B\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0445 \u0440\u0435\u043A\u0432\u0438\u0437\u0438\u0442\u043E\u0432 \u043D\u0435 \u043E\u0441\u0442\u0430\u043D\u0430\u0432\u043B\u0438\u0432\u0430\u044E\u0442 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0443." : "\u0421\u043A\u0440\u0438\u043F\u0442 \u0437\u0430\u043F\u043E\u043B\u043D\u0438\u0442 \u043E\u0434\u0438\u043D \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A \u0432 \u044D\u0442\u043E\u0439 \u0432\u043A\u043B\u0430\u0434\u043A\u0435 \u0438 \u043F\u0440\u0438\u043E\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442 \u043E\u0447\u0435\u0440\u0435\u0434\u044C. \u0414\u043E\u0431\u0430\u0432\u044C\u0442\u0435 \u043D\u0443\u0436\u043D\u044B\u0435 \u0432\u043B\u043E\u0436\u0435\u043D\u0438\u044F \u0438 \u043F\u043E\u0434\u043F\u0438\u0441\u044C. \u041E\u0442\u043F\u0440\u0430\u0432\u044C\u0442\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u0438\u043B\u0438 \u0437\u0430\u043A\u0440\u043E\u0439\u0442\u0435 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440 \u0441 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435\u043C \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A\u0430, \u0437\u0430\u0442\u0435\u043C \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0438\u0442\u044C \u043E\u0447\u0435\u0440\u0435\u0434\u044C\xBB \u0434\u043B\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0439 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438.";
    ...
    function update() {
      ...
      progress.textContent = `${summary}. ${running ? "\u041E\u0447\u0435\u0440\u0435\u0434\u044C \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0432 \u044D\u0442\u043E\u0439 \u0432\u043A\u043B\u0430\u0434\u043A\u0435." : "\u041E\u0447\u0435\u0440\u0435\u0434\u044C \u043D\u0435 \u0432\u044B\u043F\u043E\u043B\u043D\u044F\u0435\u0442\u0441\u044F."}`;
      dockProgress.textContent = summary;
      const active2 = queue.items.find(
        (item) => item.status === "opening" || item.status === "sending"
      );
      const failed = queue.items.find(
        (item) => item.status === "error" || item.status === "uncertain"
      );
      dockCurrent.textContent = active2 ? `${active2.letter.companyName} \xB7 ${labels[active2.status]}` : failed ? `${failed.letter.companyName} \xB7 ${labels[failed.status]}` : queueDelivery === "draft" && queue.items.some((item) => item.status === "queued") ? "\u0427\u0435\u0440\u043D\u043E\u0432\u0438\u043A \u043E\u0442\u043A\u0440\u044B\u0442. \u0421\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u2014 \u0447\u0435\u0440\u0435\u0437 \xAB\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0438\u0442\u044C \u043E\u0447\u0435\u0440\u0435\u0434\u044C\xBB." : queue.items.some((item) => item.status === "queued") ? "\u041E\u0447\u0435\u0440\u0435\u0434\u044C \u043E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D\u0430." : "\u0413\u043E\u0442\u043E\u0432\u043E.";
      ...
      for (const item of queue.items) {
        ...
        if (item.status === "uncertain")
          row.append(
            el(
              "p",
              "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435\xBB \u0438 \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440. \u0421\u043A\u0440\u0438\u043F\u0442 \u043D\u0435 \u043F\u043E\u0432\u0442\u043E\u0440\u044F\u0435\u0442 \u044D\u0442\u0443 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0443: \u043F\u0438\u0441\u044C\u043C\u043E \u0443\u0436\u0435 \u043C\u043E\u0433\u043B\u043E \u0443\u0439\u0442\u0438.",
              "note"
            )
          );
