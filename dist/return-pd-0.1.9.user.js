...
(() => {
  ...
  async function fillLetter(account, letter, signal, stillActive = () => true) {
    ...
    if (!root) throw new EditorError("editor_root_missing");
    const subject = one(
...
${originalSignature}` : "");
    ...
    if (subject.value !== letter.subject)
  ...
  async function consumeJob(id) {
    ...
    try {
      ...
      const error = workerErrorMessage(cause, abort.signal);
      if (store.get(key)) store.set(key, { ...job, state: "error", error });
      showWorkerNote(error, [
        "\u041D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E. \u041F\u043E\u043B\u044F \u0434\u043B\u044F \u0440\u0443\u0447\u043D\u043E\u0433\u043E \u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B \u0432 \u0438\u0441\u0445\u043E\u0434\u043D\u043E\u0439 \u043F\u0430\u043D\u0435\u043B\u0438."
      ]);
    } finally {
...
${values["\u0424\u0418\u041E"]}`
  ...
  function createLauncher(createPanel, doc = document) {
    ...
    trigger.type = "button";
    const label = "\u2197 \u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.1.9";
    ...
    try {
      GM_registerMenuCommand(
        "\u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.1.9 \u2014 \u043E\u0442\u043A\u0440\u044B\u0442\u044C",
        () => void open()
      );
    } catch {
    }
