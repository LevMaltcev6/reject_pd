...
(() => {
  ...
  async function fillLetter(account, letter, signal, stillActive = () => true) {
    const guard = () => {
      ...
      if (!sameAccount(account, identifyAccount()))
        throw new Error(
          "\u0410\u043A\u043A\u0430\u0443\u043D\u0442 \u0438\u0437\u043C\u0435\u043D\u0438\u043B\u0441\u044F \u0438\u043B\u0438 \u043D\u0435 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u044F\u0435\u0442\u0441\u044F. \u041F\u043E\u0434\u0433\u043E\u0442\u043E\u0432\u043A\u0430 \u043E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D\u0430."
        );
    };
    await waitFor(() => sameAccount(account, identifyAccount()), signal);
    guard();
...
${originalSignature}` : "");
  ...
  var BrowserTransport = class {
    ...
    async prepare(letter, signal) {
      signal.throwIfAborted();
      if (!sameAccount(this.account, identifyAccount()))
        throw new Error("\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0438\u0441\u0445\u043E\u0434\u043D\u044B\u0439 \u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u0438 \u043F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u0437\u0430\u043F\u0443\u0441\u043A.");
...
${values["\u0424\u0418\u041E"]}`
  ...
  function createLauncher(createPanel, doc = document) {
    ...
    trigger.type = "button";
    const label = "\u2197 \u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.1.4";
    ...
    try {
      GM_registerMenuCommand(
        "\u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.1.4 \u2014 \u043E\u0442\u043A\u0440\u044B\u0442\u044C",
        () => void open()
      );
    } catch {
    }
  ...
  async function mountPanel(onClose) {
    ...
    async function start() {
      safe(() => {
        ...
        const account = identifyAccount();
        if (!account)
          throw new Error(
            "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043F\u0440\u043E\u0447\u0438\u0442\u0430\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442 \u0438\u0437 \u0438\u043D\u0442\u0435\u0440\u0444\u0435\u0439\u0441\u0430 \u043F\u043E\u0447\u0442\u044B. \u0414\u043B\u044F \u042F\u043D\u0434\u0435\u043A\u0441\u0430: \u0437\u0430\u043A\u0440\u043E\u0439\u0442\u0435 \u043F\u0430\u043D\u0435\u043B\u044C, \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \u0430\u0432\u0430\u0442\u0430\u0440 \u043F\u0440\u043E\u0444\u0438\u043B\u044F, \u0437\u0430\u0442\u0435\u043C \u043E\u0442\u043A\u0440\u043E\u0439\u0442\u0435 \u043F\u0430\u043D\u0435\u043B\u044C \u0438 \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u041F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442\xBB. \u0415\u0441\u043B\u0438 \u043D\u0435 \u043F\u043E\u043C\u043E\u0433\u043B\u043E \u2014 \xAB\u0421\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0434\u0438\u0430\u0433\u043D\u043E\u0441\u0442\u0438\u043A\u0443\xBB."
          );
