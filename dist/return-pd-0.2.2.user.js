    ...
    try {
      ...
      const observeSuccess = (records = []) => {
        ...
        for (const [node, state] of notificationState(prepared)) {
          ...
          if (state.acknowledgement && (previous?.acknowledgement !== state.acknowledgement || previous.firstText !== state.firstText || state.firstText && refreshedText.has(state.firstText)) && editorGone(prepared))
            confirmed = true;
        }
      };
...
${values["\u0424\u0418\u041E"]}`
  ...
  function createLauncher(createPanel, doc = document) {
    ...
    trigger.type = "button";
    const label = "\u2197 \u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.2";
    ...
    try {
      GM_registerMenuCommand(
        "\u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.2 \u2014 \u043E\u0442\u043A\u0440\u044B\u0442\u044C",
        () => void open()
      );
    } catch {
    }
