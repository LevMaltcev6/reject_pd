...
(() => {
  ...
  var RejectedError = class extends AttemptedError {
    constructor(message) {
      super(message);
...
${originalSignature}` : "");
  ...
  function responseCode(value) {
    ...
    return text && /^[a-z0-9][a-z0-9_-]{0,79}$/i.test(text) ? text : void 0;
  }
  function record(value) {
    return value && typeof value === "object" && !Array.isArray(value) ? value : void 0;
  }
  var pendingStatuses = /* @__PURE__ */ new Set([
    "undo_message_saved",
    "delayed_message_saved",
    "undo_paused"
  ]);
  function failureFromResponse(data, httpStatus) {
    const httpFailure = httpStatus >= 400 ? { httpStatus } : void 0;
    ...
    if ([status, serverError, message, responseText(error?.code)].some(
      (value) => value && pendingStatuses.has(value)
    ))
      return;
    if ((body.status === "ok" || body.limited) && !body.error) return httpFailure;
    const code = responseCode(error?.code) || responseCode(serverError) || responseCode(message) || responseCode(status);
  ...
  function isSendRequest(doc, input, init) {
    try {
      ...
      return method.toUpperCase() === "POST" && url.origin === doc.location.origin && /(?:^|\/)do-send(?:\/|$)/.test(url.pathname) && url.searchParams.get("_send") === "true" && url.searchParams.get("_save") !== "true";
    } catch {
      return false;
    }
  }
  function senderDiagnostics(doc, init) {
    try {
      const body = init?.body;
      let fields;
      if (typeof body === "string") fields = new URLSearchParams(body);
      else if (body && Object.prototype.toString.call(body) === "[object URLSearchParams]")
        fields = body;
      else return;
      if (!["from_mailbox", "send_type", "_uid", "_mailboxUid", "mailboxUid"].some(
        (key) => fields.has(key)
      ))
        return;
      const plain = (key, limit) => {
        const value = fields.get(key);
        return value === null ? null : (responseText(value) || "").slice(0, limit);
      };
      const sender = {
  ...
  function observeYandexSendResponse(doc) {
    let active2 = false;
    let generation = 0;
    let failure;
    let restore;
    return {
      start() {
        ...
        try {
          const page = typeof unsafeWindow !== "undefined" && unsafeWindow ? unsafeWindow : doc.defaultView;
          ...
          const wrapped = function(...args) {
            ...
            try {
              if (active2 && generation === token && !captured && isSendRequest(doc, ...args)) {
                captured = true;
                const sender = senderDiagnostics(doc, args[1]);
                void result.then(async (response) => {
                  if (!active2 || generation !== token || response.status === 0)
                    return;
                  let data;
                  try {
                  ...
                  if (observed?.message && /\bfailed to auth sender\b/i.test(observed.message) && sender)
                    observed.sender = sender;
                  if (active2 && generation === token) failure = observed;
                }).catch(() => {
                });
              }
            } catch {
  ...
  var SendRejectedError = class extends Error {
  ...
  function rejectedByYandex(failure) {
    const reason = failure.message && failure.message !== failure.code ? failure.message : failure.code === "illegal_params" ? "\u041D\u0435\u043A\u043E\u0442\u043E\u0440\u044B\u0435 \u043F\u043E\u043B\u044F \u043D\u0435 \u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u044B \u0438\u043B\u0438 \u0437\u0430\u043F\u043E\u043B\u043D\u0435\u043D\u044B \u043D\u0435\u0432\u0435\u0440\u043D\u043E." : "";
    const code = failure.code ? `\u041A\u043E\u0434: ${failure.code}.` : "";
    const http = failure.httpStatus ? `HTTP ${failure.httpStatus}.` : "";
    const fieldValue = (value) => value === null ? "\u043D\u0435 \u043F\u0435\u0440\u0435\u0434\u0430\u043D" : value ? `\xAB${value}\xBB` : "\u043F\u0443\u0441\u0442\u043E\u0439";
    const sender = failure.sender ? [
      ...
      failure.sender.uidMatchesPage === false ? "\u0410\u043A\u043A\u0430\u0443\u043D\u0442 \u0432 \u0437\u0430\u043F\u0440\u043E\u0441\u0435 (_uid) \u043D\u0435 \u0441\u043E\u0432\u043F\u0430\u0434\u0430\u0435\u0442 \u0441 \u0430\u043A\u043A\u0430\u0443\u043D\u0442\u043E\u043C \u0432 \u0430\u0434\u0440\u0435\u0441\u0435 \u0432\u043A\u043B\u0430\u0434\u043A\u0438 (uid)." : "",
      failure.sender.mailboxUidFieldsMatch === false ? "\u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B \u044F\u0449\u0438\u043A\u0430 _mailboxUid \u0438 mailboxUid \u043D\u0435 \u0441\u043E\u0432\u043F\u0430\u0434\u0430\u044E\u0442." : ""
    ].filter(Boolean).join(" ") : "";
    return new SendRejectedError(
      ["\u042F\u043D\u0434\u0435\u043A\u0441 \u0441\u043E\u043E\u0431\u0449\u0438\u043B \u043E\u0431 \u043E\u0448\u0438\u0431\u043A\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438:", reason, code, http, sender].filter(Boolean).join(" "),
      failure.code
    );
  }
    ...
    try {
      ...
      const observeSuccess = (records = []) => {
        ...
        for (const record2 of records) {
          if (record2.type === "characterData" && normalize2(record2.oldValue) === normalize2(record2.target.textContent))
            refreshedText.add(record2.target);
        }
...
${values["\u0424\u0418\u041E"]}`
  ...
  function createLauncher(createPanel, doc = document) {
    ...
    trigger.type = "button";
    const label = "\u2197 \u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.14";
    ...
    try {
      GM_registerMenuCommand(
        "\u041E\u0431\u0440\u0430\u0449\u0435\u043D\u0438\u044F \u043F\u043E \u041F\u0414 \xB7 0.2.14 \u2014 \u043E\u0442\u043A\u0440\u044B\u0442\u044C",
        () => void open()
      );
    } catch {
    }
  ...
  async function mountPanel(onClose) {
    ...
    function preview() {
      ...
      deliveryNote.textContent = autoSend ? "\u041A\u043D\u043E\u043F\u043A\u0430 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C\xBB \u0437\u0430\u043F\u0443\u0441\u043A\u0430\u0435\u0442 \u0440\u0430\u0441\u0441\u044B\u043B\u043A\u0443 \u0432\u0441\u0435\u043C \u0432\u044B\u0431\u0440\u0430\u043D\u043D\u044B\u043C \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u044F\u043C \u0432 \u044D\u0442\u043E\u0439 \u0432\u043A\u043B\u0430\u0434\u043A\u0435. \u041F\u043E\u0441\u043B\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u044F \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438 \u043E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442\u0441\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0438\u0439 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440. \u041E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0442\u0435\u043A\u0441\u0442 \u0438\u0437 \u043F\u0440\u0435\u0434\u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440\u0430. \u0414\u043B\u044F \u0440\u0443\u0447\u043D\u043E\u0433\u043E \u0440\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \xAB\u0422\u043E\u043B\u044C\u043A\u043E \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A\u0438\xBB." : "\u0421\u043A\u0440\u0438\u043F\u0442 \u0437\u0430\u043F\u043E\u043B\u043D\u0438\u0442 \u043E\u0434\u0438\u043D \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A \u0432 \u044D\u0442\u043E\u0439 \u0432\u043A\u043B\u0430\u0434\u043A\u0435 \u0438 \u043F\u0440\u0438\u043E\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442 \u043E\u0447\u0435\u0440\u0435\u0434\u044C. \u0412\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u043E\u0442\u0440\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u043F\u0438\u0441\u044C\u043C\u043E. \u041E\u0442\u043F\u0440\u0430\u0432\u044C\u0442\u0435 \u0435\u0433\u043E \u0438\u043B\u0438 \u0437\u0430\u043A\u0440\u043E\u0439\u0442\u0435 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440 \u0441 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435\u043C \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A\u0430, \u0437\u0430\u0442\u0435\u043C \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0438\u0442\u044C \u043E\u0447\u0435\u0440\u0435\u0434\u044C\xBB \u0434\u043B\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0439 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438.";
    ...
    function renderResults() {
      ...
      for (const item of queue.items) {
        ...
        view.badge.textContent = item.rejected ? "\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438" : labels[item.status];
        view.error.textContent = item.error || "";
        view.error.hidden = !item.error;
        view.notice.hidden = item.status !== "uncertain" && !item.rejected;
        view.notice.textContent = item.status === "uncertain" ? "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435\xBB \u0438 \u0442\u0435\u043A\u0443\u0449\u0438\u0439 \u0440\u0435\u0434\u0430\u043A\u0442\u043E\u0440. \u0421\u043A\u0440\u0438\u043F\u0442 \u043D\u0435 \u043F\u043E\u0432\u0442\u043E\u0440\u044F\u0435\u0442 \u044D\u0442\u0443 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0443: \u043F\u0438\u0441\u044C\u043C\u043E \u0443\u0436\u0435 \u043C\u043E\u0433\u043B\u043E \u0443\u0439\u0442\u0438. \u041F\u0440\u043E\u0434\u043E\u043B\u0436\u0435\u043D\u0438\u0435 \u043E\u0447\u0435\u0440\u0435\u0434\u0438 \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0442\u043E\u043B\u044C\u043A\u043E \u043E\u0441\u0442\u0430\u0432\u0448\u0438\u0435\u0441\u044F \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438." : item.rejected ? "\u041E\u0447\u0435\u0440\u0435\u0434\u044C \u043E\u0441\u0442\u0430\u043D\u043E\u0432\u043B\u0435\u043D\u0430. \u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u043E\u0433\u043E \u043F\u043E\u0432\u0442\u043E\u0440\u0430 \u043D\u0435 \u0431\u0443\u0434\u0435\u0442." : "";
        if (item.status === "error" && item.attempted && !queue.running) {
          if (!view.retry) {
            view.retry = button(
              ...
              () => {
                if (window.confirm(
                  item.rejected ? "\u041F\u043E\u0447\u0442\u0430 \u0441\u043E\u043E\u0431\u0449\u0438\u043B\u0430 \u043E\u0431 \u043E\u0448\u0438\u0431\u043A\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043A\u0438. \u041F\u0435\u0440\u0435\u0434 \u043F\u043E\u0432\u0442\u043E\u0440\u043E\u043C \u043F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435\xBB \u0438 \u0437\u0430\u043A\u0440\u043E\u0439\u0442\u0435 \u043F\u0440\u043E\u0448\u043B\u044B\u0439 \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A. \u041F\u043E\u0432\u0442\u043E\u0440 \u0441\u043E\u0437\u0434\u0430\u0441\u0442 \u043D\u043E\u0432\u043E\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u0438 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442 \u0435\u0433\u043E. \u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C?" : queueDelivery === "send" ? "\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043D\u044B\u0435\xBB \u0438 \u043F\u0440\u043E\u0448\u043B\u044B\u0439 \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A. \u041F\u043E\u0432\u0442\u043E\u0440 \u0441\u043E\u0437\u0434\u0430\u0441\u0442 \u043D\u043E\u0432\u043E\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u0438 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438 \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442 \u0435\u0433\u043E. \u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u044C?" : "\u0423\u0431\u0435\u0434\u0438\u0442\u0435\u0441\u044C, \u0447\u0442\u043E \u043F\u0440\u043E\u0448\u043B\u043E\u0435 \u043F\u0438\u0441\u044C\u043C\u043E \u043D\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E. \u041F\u043E\u0432\u0442\u043E\u0440 \u0441\u043E\u0437\u0434\u0430\u0441\u0442 \u043D\u043E\u0432\u044B\u0439 \u0447\u0435\u0440\u043D\u043E\u0432\u0438\u043A. \u0421\u043E\u0437\u0434\u0430\u0442\u044C?"
                )) {
