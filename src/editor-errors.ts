...
const messages = {
  ...
  recipient_unconfirmed:
    "Адрес введён в «Кому», но скрипт не смог подтвердить его добавление в список получателей.",
  ...
  recipients_mismatch:
    "После заполнения список получателей не совпал с заданием. Проверьте поле «Кому» в письме.",
  subject_mismatch:
    "После заполнения тема не совпала с заданием. Проверьте тему письма.",
  body_mismatch:
    "После заполнения текст в редакторе не совпал с заданием. Проверьте текст письма.",
  body_not_committed:
    "Редактор почты не подтвердил сохранение текста письма. Отправка не запускалась. Текст можно скопировать из панели.",
  input_unavailable:
